...
## 9. DEMO_VIDEO_FIX_SPEC v1.0 への対応記録

### COMMUNITY SUPPLY の値（仕様書側の脱落を記録）

仕様書 §6.4 の参照リストは `6 → 11 → 14 → 15 → 17 → 21 → 27`（7値）だが、
...
**仕様書側で step 2 の `8` が脱落していたものとして記録する**（人間判断 2026-08-21）。
